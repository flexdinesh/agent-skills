---
name: mp-implement
description: "Implement a piece of work based on a spec or set of tickets. Use only when the user explicitly invokes `mp-implement` or `$mp-implement`; do not auto-invoke from context."
